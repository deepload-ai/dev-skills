...
4. 提供了完整的重构指南和代码模板
5. **[v2.0新增]** 生成了模块依赖图和执行流程图
6. **[v2.0新增]** 提供了变更影响分析能力
...
2. 系统架构总览.md - 理解整体架构
3. [模块]架构设计.md - 深入具体模块
4. [v2.0新增] 08-代码图谱/模块依赖图.md - 可视化依赖关系
```
...
3. 代码模板.md - 获取模板
4. 测试用例.md - 编写测试
5. [v2.0新增] 08-代码图谱/[模块]-执行流程.md - 理解调用链
```
...
阅读顺序:
1. 重构指南.md - 了解策略
2. [v2.0新增] 06-重构指南/07-变更影响分析/变更检查清单.md - 评估影响
3. 实施清单.md - 按计划执行
4. 代码模板.md - 使用模板
5. 设计模式.md - 遵循模式
```
...
2. **中文优先** - 默认使用中文，支持双语
3. **代码示例** - 提供可运行的代码示例
4. **图表辅助** - 使用 Mermaid 图表辅助说明 **[v2.0新增]**
5. **关系可视化** - 生成依赖图和执行流图 **[v2.0新增]**
...
2. **抽样检查** - 随机抽查文档质量
3. **完整性统计** - 统计文档覆盖度
4. **图表渲染** - 验证Mermaid图表可正确渲染 **[v2.0新增]**
...
3. **支撑重构** - 提供重构的完整依据
4. **便于维护** - 文档指导后续维护
5. **[v2.0新增]** **可视化关系** - 图谱展示代码关系
6. **[v2.0新增]** **影响分析** - 评估变更风险
...
3. **质量保证** - 多维度确保文档质量
4. **持续迭代** - 文档随代码持续更新
5. **[v2.0新增]** **图谱驱动** - 可视化辅助理解
6. **[v2.0新增]** **双语支持** - 满足国际化需求
...
**技能版本**: v2.0  
**最后更新**: 2026-04-13  
**更新说明**: 融合GitNexus图谱能力，新增第8层代码图谱、Mermaid可视化、变更影响分析、双语支持
